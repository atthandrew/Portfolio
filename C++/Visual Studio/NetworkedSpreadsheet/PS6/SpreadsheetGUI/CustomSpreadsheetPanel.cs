...
// Amended by Andrew Thompson u0879848 and William Meldrum u0934535
using System;
...
namespace SS
{
    ...
    public delegate void SelectionChangedHandler(CustomSpreadsheetPanel sender);
    ...
    /// 
    /// Class has been updated to support Dark and Light themes. 
    /// </summary>

    public partial class CustomSpreadsheetPanel : UserControl
    {
        ...
        /// <summary>
        /// Creates an empty CustomSpreadsheetPanel
        /// </summary>

        public CustomSpreadsheetPanel()
        {
        ...
        /// <summary>
        /// Getter method so the windows form can access the drawing panel
        /// for color changes. 
        /// </summary>
        public DrawingPanel MyDrawingPanel
        {
        ...
        public class DrawingPanel : Panel
        {
            ...
            private CustomSpreadsheetPanel _ssp;

            // These will act as color references for spreadsheet/cell drawing
            ...
            public DrawingPanel(CustomSpreadsheetPanel ss)
            {
                DoubleBuffered = true;
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                e.Graphics.FillRectangle(
                    new SolidBrush(customBackColor),
                    LABEL_COL_WIDTH,
                    LABEL_ROW_HEIGHT,
                ...
                Brush brush = new SolidBrush(customForeColor);
            ...
            private void DrawColumnLabel(Graphics g, int x, Font f)
            {
                ...
                g.DrawString(
                      label,
                      f,
                      new SolidBrush(customForeColor),
