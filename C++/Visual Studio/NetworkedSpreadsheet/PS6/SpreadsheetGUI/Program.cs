...
namespace SpreadsheetGUI
{
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            SpreadsheetApplicationContext spreadsheetContext = SpreadsheetApplicationContext.getAppContext();
            spreadsheetContext.RunForm(new Form1());
            Application.Run(spreadsheetContext);
