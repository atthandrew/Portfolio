...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        #Get all possible actions, initialize the first to be the best action
        ...
        #Look through all possible actions, keeping track of the highest QValue
    ...
    def computeActionFromQValues(self, state):
        ...
        #Look through all possible actions, setting the action with the highest QValue to be the best
        for action in possActions:
            if self.getQValue(state, action) > maxQValue:
                maxQValue = self.getQValue(state, action)
                bestAction = action
    ...
    def getAction(self, state):
        ...
        #With probability self.epsilon, take a random action from legalActions
        if (util.flipCoin(self.epsilon)):
            action = random.choice(legalActions)
        #Else, use the regular best action policy
        else:
    ...
    def update(self, state, action, nextState, reward):
        ...
        #where [sample] = R(s,a,s') + discount * maxQ(s',a')
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        #Extract a list of all features
    ...
    def update(self, state, action, nextState, reward):
        ...
        #difference = (r + alpha * maxQ(s',a')) - Q(s,a)
